...
public interface IProjectVariables {
	...
	public static final String MENU_6 = "menu6";
	...
	public static final String MENU_0 = "menu0";
	public static final String TRANSFERENCIA = "transferencia";
	public static final String POSICAO = "posicao";
	public static final String REDIRECTINFO = "redirectinfo";
	public static final String SESSION = "session";
	public static final String HORA = "hora";
	public static final String PRODUTOS_OPCIONAIS = "produtosOpcionais";
	public static final String TRANSFER_VDN = "transferVDN";
	public static final String DD_LAST_EXCEPTION = "ddLastException";
	public static final String TENTATIVAS_1 = "tentativas1";
	public static final String TENTATIVAS_2 = "tentativas2";
	public static final String TENTATIVAS_3 = "tentativas3";
	public static final String TENTATIVAS_4 = "tentativas4";
	public static final String TENTATIVAS_5 = "tentativas5";
	public static final String TENTATIVAS_6 = "tentativas6";
	...
	public static final String MENU_6_FIELD_CONFIDENCE = "confidence";
	public static final String MENU_6_FIELD_INPUTMODE = "inputmode";
	public static final String MENU_6_FIELD_INTERPRETATION = "interpretation";
	public static final String MENU_6_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String MENU_6_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String MENU_6_FIELD_UTTERANCE = "utterance";
	public static final String MENU_6_FIELD_VALUE = "value";
	public static final String MENU_5_FIELD_CONFIDENCE = "confidence";
	public static final String MENU_5_FIELD_INPUTMODE = "inputmode";
	public static final String MENU_5_FIELD_INTERPRETATION = "interpretation";
	public static final String MENU_5_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String MENU_5_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String MENU_5_FIELD_UTTERANCE = "utterance";
	public static final String MENU_5_FIELD_VALUE = "value";
	public static final String MENU_4_FIELD_CONFIDENCE = "confidence";
	public static final String MENU_4_FIELD_INPUTMODE = "inputmode";
	public static final String MENU_4_FIELD_INTERPRETATION = "interpretation";
	public static final String MENU_4_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String MENU_4_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String MENU_4_FIELD_UTTERANCE = "utterance";
	public static final String MENU_4_FIELD_VALUE = "value";
	public static final String MENU_3_FIELD_CONFIDENCE = "confidence";
	public static final String MENU_3_FIELD_INPUTMODE = "inputmode";
	public static final String MENU_3_FIELD_INTERPRETATION = "interpretation";
	public static final String MENU_3_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String MENU_3_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String MENU_3_FIELD_UTTERANCE = "utterance";
	public static final String MENU_3_FIELD_VALUE = "value";
	public static final String MENU_2_FIELD_CONFIDENCE = "confidence";
	public static final String MENU_2_FIELD_INPUTMODE = "inputmode";
	public static final String MENU_2_FIELD_INTERPRETATION = "interpretation";
	public static final String MENU_2_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String MENU_2_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String MENU_2_FIELD_UTTERANCE = "utterance";
	public static final String MENU_2_FIELD_VALUE = "value";
	public static final String MENU_0_FIELD_CONFIDENCE = "confidence";
	public static final String MENU_0_FIELD_INPUTMODE = "inputmode";
	public static final String MENU_0_FIELD_INTERPRETATION = "interpretation";
	public static final String MENU_0_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String MENU_0_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String MENU_0_FIELD_UTTERANCE = "utterance";
	public static final String MENU_0_FIELD_VALUE = "value";
