 ...
 */
public class untitledDisconnect1 extends com.avaya.sce.runtime.Disconnect {
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.OnDisconnect("untitledReturn1", false);
		list.add(event);
		return(list);
	}
	/**
