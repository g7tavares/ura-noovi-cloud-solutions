...
public class menu3 extends com.avaya.sce.runtime.Menu {
	 ...
	 * Last generated by Orchestration Designer at: 18 DE ABRIL DE 2022 11H13MIN42S BRT
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("1", "1", true, "exact", "repeat", grammarInfo, true);
		list.add(choice);
