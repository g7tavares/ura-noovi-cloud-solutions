 ...
 */
public class speak_excedeu_tentativas2 extends com.avaya.sce.runtime.Form {
	 ...
	 * Last generated by Orchestration Designer at: 31 DE MARÇO DE 2022 12H52MIN15S BRT
	 */
	public speak_excedeu_tentativas2() {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("prompt_excedeu_tentativas", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("Subfluxo_1-Subfluxo_2");
		return submit;
	}
	/**
