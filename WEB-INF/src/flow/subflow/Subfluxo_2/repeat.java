 ...
 * Last generated by Orchestration Designer at: 11 DE ABRIL DE 2022 11H11MIN46S BRT
 */
public class repeat extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("pmt_repeat", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("Subfluxo_2-speak_disconnect");
		return submit;
	}
	/**
