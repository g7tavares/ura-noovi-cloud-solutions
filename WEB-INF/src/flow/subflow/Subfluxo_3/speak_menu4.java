 ...
 * Last generated by Orchestration Designer at: 12 DE ABRIL DE 2022 10H30MIN13S BRT
 */
public class speak_menu4 extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("pmt015", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("Subfluxo_3-reset_tentativas_4");
		return submit;
	}
	/**
