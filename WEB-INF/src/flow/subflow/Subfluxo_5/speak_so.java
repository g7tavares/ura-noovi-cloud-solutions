 ...
 * Last generated by Orchestration Designer at: 13 DE ABRIL DE 2022 12H43MIN3S BRT
 */
public class speak_so extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("pmt023", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("Subfluxo_5-reset_tentativas_6");
		return submit;
	}
	/**
