 ...
 * Last generated by Orchestration Designer at: 31 DE MARÇO DE 2022 12H54MIN26S BRT
 */
public class speak_transfere extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("prompt_transfere", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("Subfluxo_0-transferencia");
		return submit;
	}
	/**
