...
public class Start extends com.avaya.sce.runtime.Entry {
	 ...
	 * Last generated by Orchestration Designer at: 8 DE ABRIL DE 2022 11H41MIN24S BRT
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variableFields = new String[] {
			IProjectVariables.MENU__OPCOES_FIELD_CONFIDENCE,
			IProjectVariables.MENU__OPCOES_FIELD_INPUTMODE,
			IProjectVariables.MENU__OPCOES_FIELD_INTERPRETATION,
			IProjectVariables.MENU__OPCOES_FIELD_NOINPUTCOUNT,
			IProjectVariables.MENU__OPCOES_FIELD_NOMATCHCOUNT,
			IProjectVariables.MENU__OPCOES_FIELD_UTTERANCE,
			IProjectVariables.MENU__OPCOES_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.MENU__OPCOES, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.MENU_2__DTMF, "0", null, session, false, false );
		session.putVariable(variable);
