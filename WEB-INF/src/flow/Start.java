 ...
 * code generator.<br>
 * Last generated by Orchestration Designer at: 31 DE MARÇO DE 2022 10H38MIN8S BRT
 */
public class Start extends com.avaya.sce.runtime.Entry {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Submit submit = new com.avaya.sce.runtime.Submit("check_hora");
		return ( submit );
	}
	/**
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variableFields = new String[] {
			IProjectVariables.MENU_6_FIELD_CONFIDENCE,
			IProjectVariables.MENU_6_FIELD_INPUTMODE,
			IProjectVariables.MENU_6_FIELD_INTERPRETATION,
			IProjectVariables.MENU_6_FIELD_NOINPUTCOUNT,
			IProjectVariables.MENU_6_FIELD_NOMATCHCOUNT,
			IProjectVariables.MENU_6_FIELD_UTTERANCE,
			IProjectVariables.MENU_6_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.MENU_6, variableFields, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.MENU_5_FIELD_CONFIDENCE,
			IProjectVariables.MENU_5_FIELD_INPUTMODE,
			IProjectVariables.MENU_5_FIELD_INTERPRETATION,
			IProjectVariables.MENU_5_FIELD_NOINPUTCOUNT,
			IProjectVariables.MENU_5_FIELD_NOMATCHCOUNT,
			IProjectVariables.MENU_5_FIELD_UTTERANCE,
			IProjectVariables.MENU_5_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.MENU_5, variableFields, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.MENU_4_FIELD_CONFIDENCE,
			IProjectVariables.MENU_4_FIELD_INPUTMODE,
			IProjectVariables.MENU_4_FIELD_INTERPRETATION,
			IProjectVariables.MENU_4_FIELD_NOINPUTCOUNT,
			IProjectVariables.MENU_4_FIELD_NOMATCHCOUNT,
			IProjectVariables.MENU_4_FIELD_UTTERANCE,
			IProjectVariables.MENU_4_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.MENU_4, variableFields, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.MENU_3_FIELD_CONFIDENCE,
			IProjectVariables.MENU_3_FIELD_INPUTMODE,
			IProjectVariables.MENU_3_FIELD_INTERPRETATION,
			IProjectVariables.MENU_3_FIELD_NOINPUTCOUNT,
			IProjectVariables.MENU_3_FIELD_NOMATCHCOUNT,
			IProjectVariables.MENU_3_FIELD_UTTERANCE,
			IProjectVariables.MENU_3_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.MENU_3, variableFields, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.MENU_2_FIELD_CONFIDENCE,
			IProjectVariables.MENU_2_FIELD_INPUTMODE,
			IProjectVariables.MENU_2_FIELD_INTERPRETATION,
			IProjectVariables.MENU_2_FIELD_NOINPUTCOUNT,
			IProjectVariables.MENU_2_FIELD_NOMATCHCOUNT,
			IProjectVariables.MENU_2_FIELD_UTTERANCE,
			IProjectVariables.MENU_2_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.MENU_2, variableFields, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.MENU_0_FIELD_CONFIDENCE,
			IProjectVariables.MENU_0_FIELD_INPUTMODE,
			IProjectVariables.MENU_0_FIELD_INTERPRETATION,
			IProjectVariables.MENU_0_FIELD_NOINPUTCOUNT,
			IProjectVariables.MENU_0_FIELD_NOMATCHCOUNT,
			IProjectVariables.MENU_0_FIELD_UTTERANCE,
			IProjectVariables.MENU_0_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.MENU_0, variableFields, null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.TRANSFERENCIA, "", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.POSICAO, "0", null, session, false, false );
		session.putVariable(variable);
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.HORA, "", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.PRODUTOS_OPCIONAIS, "", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.TRANSFER_VDN, "", "com.avaya.vp.admin.variables.runtime.AdminVariableFactory", session, false, false );
		session.putVariable(variable);
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.TENTATIVAS_1, "0", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.TENTATIVAS_2, "0", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.TENTATIVAS_3, "0", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.TENTATIVAS_4, "0", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.TENTATIVAS_5, "0", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.TENTATIVAS_6, "", null, session, false, false );
		session.putVariable(variable);
